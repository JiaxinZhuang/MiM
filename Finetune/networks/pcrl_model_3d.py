...
class PCRLModel3d(nn.Module):
    ...
    def __init__(self, num_classes=1, act='relu', norm='bn', in_channels=1, low_dim=128, student=False):
    ...
    def forward(self, x, feats_ema=None, alpha=1.0, aug_tensor1=None, aug_tensor2=None, mixup=False):
        b = x.shape[0]
        ...
        if self.student:
            ...
            out512_ema = skip_out128_ema = skip_out256_ema = skip_out64_ema = 0
