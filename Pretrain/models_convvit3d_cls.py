...
class ConvViT3d(torch.nn.Module):
    ...
    def __init__(self, img_size=[512, 128, 64], patch_size=[4,2,2], in_chans=3, num_classes=80, embed_dim=[256,384,768], depth=[2,2,11],
                 ...
                 use_abs_pos_emb=True, use_rel_pos_bias=True, use_shared_rel_pos_bias=False, global_pool=True,
...
def convvit3d_base_patch16_384x384x32_dec512d8b(**kwargs):
    ''' 3d convvit with input size
    :192->96->48->24
    '''
    model = ConvViT3d(
        in_chans=1,
        # img_size=[[32, 384, 384], [16, 192, 192], [8, 96, 96], [4, 48, 48]],
        img_size=[[16, 384, 384], [8, 192, 192], [4, 96, 96], [2, 48, 48]],
        patch_size=[2, 2, 2, 2],
        embed_dim=[48, 96, 192, 384],
        depth=[2, 2, 2, 11],
        num_heads=12,
...
convvit3d_base_patch16_CC_CCII = convvit3d_base_patch16_384x384x32_dec512d8b
