...
#        torch.nn.init.normal_(self.cls_token, std=.02)
    ...
    def forward(self, imgs):
        ...
        return [loss_up, loss_mid, loss_down, loss_upmid, loss_middown], pred_up, pred_mid, pred_down, mask_up, mask_mid, mask_down, ids_restore_up, ids_restore_mid, ids_restore_down
