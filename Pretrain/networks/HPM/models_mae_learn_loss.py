...
class MaskedAutoencoderViT(nn.Module):
    ...
    def __init__(self, img_size=96, patch_size=16, in_chans=1,
        ...
        self.decoder_pred_losspred = nn.Linear(decoder_embed_dim, patch_size ** 3 * in_chans, bias=True)  # decoder to patch
        # --------------------------------------------------------------------------
    ...
    def initialize_weights(self):
        ...
        # pos_embed = get_3d_sincos_pos_embed(self.pos_embed.shape[-1], int(self.patch_embed.num_patches ** .5),
                                            # cls_token=True)
