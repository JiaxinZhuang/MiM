...
- VoCo, pretrained on the largest 3D medical image datasets, and achieves new state-of-the-art performance on multiple 3D medical image analysis tasks. Code: https://github.com/Luffy03/VoCo
